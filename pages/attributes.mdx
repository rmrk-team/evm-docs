...
We published an Ethereum Improvement Proposal detailing the specification of the On-Chain Attributes extension. If you are interested, you can access it [here](https://eips.ethereum.org/EIPS/eip-7508).
