...
<Image src="/images/multiasset.webp" alt="MultiAsset" width={500} height={500} />
...
We published an Ethereum Improvement Proposal detailing the specification of the MultiAsset RMRK module. If you are interested, you can access it [here](ERC-5773: Context-Dependent Multi-Asset Tokens).
