...
Equippable & Composable is the most advanced module, as it requires both MultiAsset and Nestable ones. After you have deployed your NFT contract, you may add new equipppable and/or composable assets, which can receive children to be equipped or which can be equipped into a parent. These are the operations you may need to perform:
