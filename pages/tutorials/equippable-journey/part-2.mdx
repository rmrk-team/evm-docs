...
We already have hardhat node running and have deployed our main and utility contracts deployed. The next step is to clone the [RMRK's examples repo](https://github.com/rmrk-team/rmrk-examples) repository, go to the `react-nextjs-example` and install dependencies.
